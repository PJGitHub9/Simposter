...
// merged-grid dedup those two grids use. `mediaType` is fixed at this
// component's own creation (route.name doesn't change without a full
// remount between /movies/backdrops and /tv-shows/backdrops).
